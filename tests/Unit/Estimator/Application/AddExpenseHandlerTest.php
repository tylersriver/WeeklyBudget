...
describe('AddExpenseHandler', function () {
    it('adds expense via repository', function () {
        ...
        $handler(new AddExpenseCommand(name: 'Rent', amount: '1500', category: 'Bills'));
    });
    ...
    it('rejects empty name', function () {
        ...
        $handler(new AddExpenseCommand(name: '', amount: '100', category: 'Bills'));
    ...
    it('rejects invalid category', function () {
        ...
        $handler(new AddExpenseCommand(name: 'Test', amount: '100', category: 'Invalid'));
    ...
    it('rejects non-positive amount', function () {
        ...
        $handler(new AddExpenseCommand(name: 'Rent', amount: '0', category: 'Bills'));
